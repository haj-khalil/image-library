...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        edt_usr = new QLineEdit(centralwidget);
        edt_usr->setObjectName(QString::fromUtf8("edt_usr"));

        verticalLayout->addWidget(edt_usr);
        ...
        edt_mdp = new QLineEdit(centralwidget);
        edt_mdp->setObjectName(QString::fromUtf8("edt_mdp"));

        verticalLayout->addWidget(edt_mdp);

        btn_connection = new QPushButton(centralwidget);
        btn_connection->setObjectName(QString::fromUtf8("btn_connection"));

        verticalLayout->addWidget(btn_connection);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_connection->setText(QCoreApplication::translate("MainWindow", "Connection", nullptr));
